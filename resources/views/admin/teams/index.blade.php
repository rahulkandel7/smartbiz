        ...
        <div class="px-5 py-5">
            ...
            <hr>
                ...
                <div class="w-44 h-32 mx-4 mt-4 p-2 shadow-md dark:shadow-indigo-800 rounded-md bg-indigo-500 shadow-indigo-200 hover:shadow-sm hover:cursor-pointer">
                    ...
                    <h1 class="text-4xl font-bold text-right text-white mr-4">{{count($teams)}}</h1>
                    </div>
                </div>
            ...
            <table class="border border-gray-200 w-full mt-10 shadow-md rounded-md ">
                ...
                @foreach ($teams as $team)
                    <tr>
                        ...
                        <td class="text-gray-900 font-bold px-5 border dark:text-white">
                            <img src="/storage/{{$team->photopath}}" class="w-44">
                        </td>
                        <td class="text-gray-600 font-semibold px-5 border w-32 py-2">
                            <a href="{{ $team->fblink }}">
                                <i class="fab fa-facebook hover:text-blue-900 font-bold cursor-pointer text-xl dark:text-blue-300 dark:hover:text-blue-500"></i>
                            </a>
                            
                            <a href="{{ $team->instalink }}">
                                <i class="fab fa-instagram hover:text-red-900 px-2 font-bold cursor-pointer text-xl dark:text-blue-300 dark:hover:text-blue-500"></i>
                            </a>
                        ...
                        <td class="text-gray-600 font-semibold px-5 border w-32 py-2">
                            ...
                            <button onclick="showdelete({{$team->id}})">
            ...
            <div id="deletemodal"  class="white-card hidden dark:bg-white dark:bg-opacity-10 overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-20 z-50 justify-center items-center md:h-full md:inset-0  align-middle"  >
                <div class="relative px-4 w-full max-w-md h-full md:h-auto mx-auto ">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" method="POST" action="{{route('admin.teams.delete')}}">
                        @csrf
