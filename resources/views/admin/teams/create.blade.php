        ...
        <div class="px-5 py-5">
            ...
            <form method="post" action="{{route('admin.teams.store')}}" enctype="multipart/form-data">
                ...
                <div class="mt-5">
                    ...
                    <input type="text" name="fblink" id="fblink" class="border-[#5976e970] border-2 rounded-md w-full focus:ring-transparent focus:border-[#284b81] bg-transparent mt-2" value="{{old('fblink')}}">
                </div>

                {{-- For instalink --}}
                <div class="mt-5">
                    <label for="instalink" class="block font-bold text-gray-600 dark:text-gray-200">Instagram Link</label>
                    <input type="text" name="instalink" id="instalink" class="border-[#5976e970] border-2 rounded-md w-full focus:ring-transparent focus:border-[#284b81] bg-transparent mt-2" value="{{old('instalink')}}">
                </div>
