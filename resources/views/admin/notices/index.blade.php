    ...
    <div class="flex-1">
        <div class="px-5 py-5">
            ...
            <hr>
                ...
                <div class="w-44 h-32 mx-4 mt-4 p-2 shadow-md dark:shadow-sky-800 rounded-md bg-sky-500 shadow-sky-200 hover:shadow-sm hover:cursor-pointer">
                    <h2 class="text-xl font-bold text-white">No of Notices</h2>
                    <div class="flex justify-between">
                        <i class="fas fa-clipboard fa-2x text-white opacity-70"></i>
                    <h1 class="text-4xl font-bold text-right text-white mr-4">{{count($notices)}}</h1>
                    </div>
                </div>
                ...
                @foreach ($notices as $notice)
                    <tr>
                        ...
                        <td class="text-gray-600 font-semibold px-5 border w-32 py-2">
                            ...
                            <button onclick="showdelete({{$notice->id}})">
            ...
            <div id="deletemodal"  class="white-card hidden dark:bg-white dark:bg-opacity-10 overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-20 z-50 justify-center items-center md:h-full md:inset-0  align-middle"  >
                <div class="relative px-4 w-full max-w-md h-full md:h-auto mx-auto ">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" method="POST" action="{{route('admin.notices.delete')}}">
                        @csrf
